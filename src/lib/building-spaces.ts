 ...
 * selects the exterior orientation shot used for the hotspot map and as the fallback
 * stage. `pin` positions the numbered hotspot over the aerial "site overview"
 * viewpoint as a rough orientation marker; spaces without a pin are reachable from the
 * tour list and story cards.
 */
