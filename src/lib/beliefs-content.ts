/**
 * Canonical content for the 28 Fundamental Beliefs of the Seventh-day Adventist Church.
 *
 * Text follows the official General Conference statement verbatim (2020 Edition,
 * © 2020 General Conference of Seventh-day Adventists — adventist.org/beliefs). This module
 * is the authoring source of truth for the public /beliefs page and is also consumed by
 * prisma/seed.ts so the DB-backed reference system (/reference/[slug], search, sitemap)
 * stays consistent.
 *
 * Because doctrinal statements are static reference text, keeping them in code lets the public
 * page render the full content immediately on deploy — it does not depend on a database reseed.
 *
 * The six category groupings mirror the doctrinal structure the church uses to organize the
 * beliefs (God, humanity, salvation, the church, the Christian life, and restoration).
 */

export const BELIEFS_EDITION = "28 Fundamental Beliefs (2020)";
export const BELIEFS_SOURCE_URL = "https://www.adventist.org/beliefs/";

/** Official preamble that heads the General Conference statement. */
export const BELIEFS_PREAMBLE =
...
export type Belief = {
  number: number;
  /** Stable slug, matching the seeded ReferenceDocument (fb-1 … fb-28). */
  slug: string;
  title: string;
  categoryId: BeliefCategoryId;
  /** Full statement, one entry per paragraph. */
  body: string[];
  /** Scripture references cited with the belief. */
...
export const BELIEF_CATEGORIES: BeliefCategory[] = [
  {
    ...
    blurb: "Who God is — the Scriptures that reveal Him, and the triune God they make known.",
  },
  {
    id: "humanity",
    title: "The Doctrine of Humanity",
    blurb: "How we were created, why the world is broken, and the conflict behind it all.",
  },
  {
    id: "salvation",
    title: "The Doctrine of Salvation",
    blurb: "What Christ has done for us, and the new life He gives to all who trust Him.",
  },
  {
    id: "church",
    title: "The Doctrine of the Church",
    blurb: "The community of believers — its mission, unity, ordinances, and gifts.",
  },
  {
    id: "christian-life",
    title: "The Doctrine of the Christian Life",
    blurb: "How grace reshapes daily life — God’s law, the Sabbath, our bodies, our homes.",
  },
  {
    id: "restoration",
    title: "The Doctrine of Restoration",
    blurb: "The blessed hope — Christ’s ministry, His return, and the earth made new.",
  },
];
...
export const BELIEFS: Belief[] = [
  {
    ...
    scriptureRefs: ["Ps 119:105", "Prov 30:5,6", "Isa 8:20", "John 17:17", "1 Thess 2:13", "2 Tim 3:16,17", "Heb 4:12", "2 Peter 1:20,21"],
  },
  {
    number: 2,
    slug: "fb-2",
    ...
    scriptureRefs: ["Gen 1:26", "Deut 6:4", "Isa 6:8", "Matt 28:19", "John 3:16", "2 Cor 1:21,22", "2 Cor 13:14", "Eph 4:4-6", "1 Peter 1:2"],
  },
  {
    number: 3,
    slug: "fb-3",
    ...
    scriptureRefs: ["Gen 1:1", "Deut 4:35", "Ps 110:1,4", "John 3:16", "John 14:9", "1 Cor 15:28", "1 Tim 1:17", "1 John 4:8", "Rev 4:11"],
  },
  {
    number: 4,
    slug: "fb-4",
    ...
    scriptureRefs: ["Isa 53:4-6", "Dan 9:25-27", "Luke 1:35", "John 1:1-3,14", "John 5:22", "John 10:30", "John 14:1-3,9,13", "Rom 6:23", "1 Cor 15:3,4", "2 Cor 3:18", "2 Cor 5:17-19", "Phil 2:5-11", "Col 1:15-19", "Heb 2:9-18", "Heb 8:1,2"],
  },
  {
    number: 5,
    slug: "fb-5",
    ...
    scriptureRefs: ["Gen 1:1,2", "2 Sam 23:2", "Ps 51:11", "Isa 61:1", "Luke 1:35", "Luke 4:18", "John 14:16-18,26", "John 15:26", "John 16:7-13", "Acts 1:8", "Acts 5:3", "Acts 10:38", "Rom 5:5", "1 Cor 12:7-11", "2 Cor 3:18", "2 Peter 1:21"],
  },
  {
    number: 6,
    slug: "fb-6",
    ...
    scriptureRefs: ["Gen 1-2", "Gen 5", "Gen 11", "Exod 20:8-11", "Ps 19:1-6", "Ps 33:6,9", "Ps 104", "Isa 45:12,18", "Acts 17:24", "Col 1:16", "Heb 1:2", "Heb 11:3", "Rev 10:6", "Rev 14:7"],
  },
  {
    number: 7,
    slug: "fb-7",
    ...
    scriptureRefs: ["Gen 1:26-28", "Gen 2:7,15", "Gen 3", "Ps 8:4-8", "Ps 51:5,10", "Ps 58:3", "Jer 17:9", "Acts 17:24-28", "Rom 5:12-17", "2 Cor 5:19,20", "Eph 2:3", "1 Thess 5:23", "1 John 3:4", "1 John 4:7,8,11,20"],
  },
  {
    number: 8,
    slug: "fb-8",
    ...
    scriptureRefs: ["Gen 3", "Gen 6-8", "Job 1:6-12", "Isa 14:12-14", "Ezek 28:12-18", "Rom 1:19-32", "Rom 3:4", "Rom 5:12-21", "Rom 8:19-22", "1 Cor 4:9", "Heb 1:14", "1 Peter 5:8", "2 Peter 3:6", "Rev 12:4-9"],
  },
  {
    number: 9,
    slug: "fb-9",
    title: "The Life, Death, and Resurrection of Christ",
    categoryId: "salvation",
    body: [
    ...
    scriptureRefs: ["Gen 3:15", "Ps 22:1", "Isa 53", "John 3:16", "John 14:30", "Rom 1:4", "Rom 3:25", "Rom 4:25", "Rom 8:3,4", "1 Cor 15:3,4,20-22", "2 Cor 5:14,15,19-21", "Phil 2:6-11", "Col 2:15", "1 Peter 2:21,22", "1 John 2:2", "1 John 4:10"],
  },
  {
    number: 10,
    slug: "fb-10",
    ...
    scriptureRefs: ["Gen 3:15", "Isa 45:22", "Isa 53", "Jer 31:31-34", "Ezek 33:11", "Ezek 36:25-27", "Hab 2:4", "Mark 9:23,24", "John 3:3-8,16", "John 16:8", "Rom 3:21-26", "Rom 8:1-4,14-17", "Rom 5:6-10", "Rom 10:17", "Rom 12:2", "2 Cor 5:17-21", "Gal 1:4", "Gal 3:13,14,26", "Gal 4:4-7", "Eph 2:4-10", "Col 1:13,14", "Titus 3:3-7", "Heb 8:7-12", "1 Peter 1:23", "1 Peter 2:21,22", "2 Peter 1:3,4", "Rev 13:8"],
  },
  {
    number: 11,
    slug: "fb-11",
    ...
    scriptureRefs: ["1 Chron 29:11", "Ps 1:1,2", "Ps 23:4", "Ps 77:11,12", "Matt 20:25-28", "Matt 25:31-46", "Luke 10:17-20", "John 20:21", "Rom 8:38,39", "2 Cor 3:17,18", "Gal 5:22-25", "Eph 5:19,20", "Eph 6:12-18", "Phil 3:7-14", "Col 1:13,14", "Col 2:6,14,15", "1 Thess 5:16-18,23", "Heb 10:25", "James 1:27", "2 Peter 2:9", "2 Peter 3:18", "1 John 4:4"],
  },
  {
    number: 12,
    slug: "fb-12",
    ...
    scriptureRefs: ["Gen 12:1-3", "Exod 19:3-7", "Matt 16:13-20", "Matt 18:18", "Matt 28:19,20", "Acts 2:38-42", "Acts 7:38", "1 Cor 1:2", "Eph 1:22,23", "Eph 2:19-22", "Eph 3:8-11", "Eph 5:23-27", "Col 1:17,18", "1 Peter 2:9"],
  },
  {
    number: 13,
    slug: "fb-13",
    ...
    scriptureRefs: ["Dan 7:9-14", "Isa 1:9", "Isa 11:11", "Jer 23:3", "Micah 2:12", "2 Cor 5:10", "1 Peter 1:16-19", "1 Peter 4:17", "2 Peter 3:10-14", "Jude 3,14", "Rev 12:17", "Rev 14:6-12", "Rev 18:1-4"],
  },
  {
    number: 14,
    slug: "fb-14",
    ...
    scriptureRefs: ["Ps 133:1", "Matt 28:19,20", "John 17:20-23", "Acts 17:26,27", "Rom 12:4,5", "1 Cor 12:12-14", "2 Cor 5:16,17", "Gal 3:27-29", "Eph 2:13-16", "Eph 4:3-6,11-16", "Col 3:10-15"],
  },
  {
    number: 15,
    slug: "fb-15",
    ...
    scriptureRefs: ["Matt 28:19,20", "Acts 2:38", "Acts 16:30-33", "Acts 22:16", "Rom 6:1-6", "Gal 3:27", "Col 2:12,13"],
  },
  {
    number: 16,
    slug: "fb-16",
    ...
    scriptureRefs: ["Matt 26:17-30", "John 6:48-63", "John 13:1-17", "1 Cor 10:16,17", "1 Cor 11:23-30", "Rev 3:20"],
  },
  {
    number: 17,
    slug: "fb-17",
    ...
    scriptureRefs: ["Acts 6:1-7", "Rom 12:4-8", "1 Cor 12:7-11,27,28", "Eph 4:8,11-16", "1 Tim 3:1-13", "1 Peter 4:10,11"],
  },
  {
    number: 18,
    slug: "fb-18",
    ...
    scriptureRefs: ["Num 12:6", "2 Chron 20:20", "Amos 3:7", "Joel 2:28,29", "Acts 2:14-21", "2 Tim 3:16,17", "Heb 1:1-3", "Rev 12:17", "Rev 19:10", "Rev 22:8,9"],
  },
  {
    number: 19,
    slug: "fb-19",
    title: "The Law of God",
    categoryId: "christian-life",
    body: [
    ...
    scriptureRefs: ["Exod 20:1-17", "Deut 28:1-14", "Ps 19:7-14", "Ps 40:7,8", "Matt 5:17-20", "Matt 22:36-40", "John 14:15", "John 15:7-10", "Rom 8:3,4", "Eph 2:8-10", "Heb 8:8-10", "1 John 2:3", "1 John 5:3", "Rev 12:17", "Rev 14:12"],
  },
  {
    number: 20,
    slug: "fb-20",
    ...
    scriptureRefs: ["Gen 2:1-3", "Exod 20:8-11", "Exod 31:13-17", "Lev 23:32", "Deut 5:12-15", "Isa 56:5,6", "Isa 58:13,14", "Ezek 20:12,20", "Matt 12:1-12", "Mark 1:32", "Luke 4:16", "Heb 4:1-11"],
  },
  {
    number: 21,
    slug: "fb-21",
    ...
    scriptureRefs: ["Gen 1:26-28", "Gen 2:15", "1 Chron 29:14", "Haggai 1:3-11", "Mal 3:8-12", "Matt 23:23", "Rom 15:26,27", "1 Cor 9:9-14", "2 Cor 8:1-15", "2 Cor 9:7"],
  },
  {
    number: 22,
    slug: "fb-22",
    ...
    scriptureRefs: ["Gen 7:2", "Exod 20:15", "Lev 11:1-47", "Ps 106:3", "Rom 12:1,2", "1 Cor 6:19,20", "1 Cor 10:31", "2 Cor 6:14-7:1", "2 Cor 10:5", "Eph 5:1-21", "Phil 2:4", "Phil 4:8", "1 Tim 2:9,10", "Titus 2:11,12", "1 Peter 3:1-4", "1 John 2:6", "3 John 2"],
  },
  {
    number: 23,
    slug: "fb-23",
    ...
    scriptureRefs: ["Gen 2:18-25", "Exod 20:12", "Deut 6:5-9", "Prov 22:6", "Mal 4:5,6", "Matt 5:31,32", "Matt 19:3-9,12", "Mark 10:11,12", "John 2:1-11", "1 Cor 7:7,10,11", "2 Cor 6:14", "Eph 5:21-33", "Eph 6:1-4"],
  },
  {
    number: 24,
    slug: "fb-24",
    ...
    scriptureRefs: ["Lev 16", "Num 14:34", "Ezek 4:6", "Dan 7:9-27", "Dan 8:13,14", "Dan 9:24-27", "Heb 1:3", "Heb 2:16,17", "Heb 4:14-16", "Heb 8:1-5", "Heb 9:11-28", "Heb 10:19-22", "Rev 8:3-5", "Rev 11:19", "Rev 14:6,7", "Rev 20:12", "Rev 14:12", "Rev 22:11,12"],
  },
  {
    number: 25,
    slug: "fb-25",
    ...
    scriptureRefs: ["Matt 24", "Mark 13", "Luke 21", "John 14:1-3", "Acts 1:9-11", "1 Cor 15:51-54", "1 Thess 4:13-18", "1 Thess 5:1-6", "2 Thess 1:7-10", "2 Thess 2:8", "2 Tim 3:1-5", "Titus 2:13", "Heb 9:28", "Rev 1:7", "Rev 14:14-20", "Rev 19:11-21"],
  },
  {
    number: 26,
    slug: "fb-26",
    ...
    scriptureRefs: ["Job 19:25-27", "Ps 146:3,4", "Eccl 9:5,6,10", "Dan 12:2,13", "Isa 25:8", "John 5:28,29", "John 11:11-14", "Rom 6:23", "1 Cor 15:51-54", "Col 3:4", "1 Thess 4:13-17", "1 Tim 6:15", "Rev 20:1-10"],
  },
  {
    number: 27,
    slug: "fb-27",
    ...
    scriptureRefs: ["Jer 4:23-26", "Ezek 28:18,19", "Mal 4:1", "1 Cor 6:2,3", "Rev 20", "Rev 21:1-5"],
  },
  {
    number: 28,
    slug: "fb-28",
    ...
    scriptureRefs: ["Isa 35", "Isa 65:17-25", "Matt 5:5", "2 Peter 3:13", "Rev 11:15", "Rev 21:1-7", "Rev 22:1-5"],
  },
];

/** Beliefs belonging to a category, in canonical order. */
export function beliefsInCategory(categoryId: BeliefCategoryId): Belief[] {
  return BELIEFS.filter((b) => b.categoryId === categoryId);
}

/** Render a belief's body paragraphs to the sanitized-safe HTML stored in ReferenceDocument. */
export function beliefBodyHtml(belief: Belief): string {
  return belief.body.map((p) => `<p>${p}</p>`).join("\n");
}
